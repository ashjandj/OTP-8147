define('global_views_pagination.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "		<li class=\"global-views-pagination-prev\">\n			<a href=\""
    + alias3(((helper = (helper = compilerNameLookup(helpers,"previousPageURL") || (depth0 != null ? compilerNameLookup(depth0,"previousPageURL") : depth0)) != null ? helper : alias2),(typeof helper === "function" ? helper.call(alias1,{"name":"previousPageURL","hash":{},"data":data,"loc":{"start":{"line":11,"column":12},"end":{"line":11,"column":31}}}) : helper)))
    + "\" title=\""
    + alias3((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"previous page","pagination previous page button",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":11,"column":40},"end":{"line":11,"column":103}}}))
    + "\">\n				<i class=\"global-views-pagination-prev-icon\"></i>\n			</a>\n		</li>\n";
},"8":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.hooks.helperMissing, alias3=container.escapeExpression;

  return "		<li class=\"global-views-pagination-prev-disabled\">\n			<a href=\""
    + alias3(((helper = (helper = compilerNameLookup(helpers,"currentPageURL") || (depth0 != null ? compilerNameLookup(depth0,"currentPageURL") : depth0)) != null ? helper : alias2),(typeof helper === "function" ? helper.call(alias1,{"name":"currentPageURL","hash":{},"data":data,"loc":{"start":{"line":17,"column":12},"end":{"line":17,"column":30}}}) : helper)))
    + "\" title=\""
    + alias3((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"previous page disabled","pagination previous page button disabled",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":17,"column":39},"end":{"line":17,"column":120}}}))
    + "\">\n				<i class=\"global-views-pagination-prev-icon\"></i>\n			</a>\n		</li>\n";
  ...
  return "		<li class=\"global-views-pagination-next-disabled\">\n			<a href=\""
    + alias3(((helper = (helper = compilerNameLookup(helpers,"currentPageURL") || (depth0 != null ? compilerNameLookup(depth0,"currentPageURL") : depth0)) != null ? helper : alias2),(typeof helper === "function" ? helper.call(alias1,{"name":"currentPageURL","hash":{},"data":data,"loc":{"start":{"line":51,"column":12},"end":{"line":51,"column":30}}}) : helper)))
    + "\" title=\""
    + alias3((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"next page not available","pagination next page button disabled",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":51,"column":39},"end":{"line":51,"column":117}}}))
    + "\">\n				<i class=\"global-views-pagination-next-icon\"></i>\n			</a>\n		</li>\n";
},"20":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.hooks.helperMissing, alias3=container.escapeExpression;

  return "		<li class=\"global-views-pagination-next\">\n			<a href=\""
    + alias3(((helper = (helper = compilerNameLookup(helpers,"nextPageURL") || (depth0 != null ? compilerNameLookup(depth0,"nextPageURL") : depth0)) != null ? helper : alias2),(typeof helper === "function" ? helper.call(alias1,{"name":"nextPageURL","hash":{},"data":data,"loc":{"start":{"line":57,"column":12},"end":{"line":57,"column":27}}}) : helper)))
    + "\" title=\""
    + alias3((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"next page","pagination next page button",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":57,"column":36},"end":{"line":57,"column":91}}}))
    + "\">\n				<i class=\"global-views-pagination-next-icon\"></i>\n			</a>\n		</li>\n";
  ...
  return ((stack1 = compilerNameLookup(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? compilerNameLookup(depth0,"currentPageLowerThanTotalPagesAndCurrentPageGreaterThan0AndPagesCountGreaterThan1") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":64,"column":7}}})) != null ? stack1 : "")
    + "\n\n\n\n";
},"useData":true}; var main = t.main; t.main = function(){ arguments[1] = arguments[1] || {}; var ctx = arguments[1]; ctx._extension_path = 'http://localhost:7777/tmp/extensions/SuiteCommerce/Suite_Commerce_Base_Theme/24.1.30/'; ctx._theme_path = 'http://localhost:7777/tmp/extensions/SuiteCommerce/Suite_Commerce_Base_Theme/24.1.30/'; return main.apply(this, arguments); }; var template = Handlebars.template(t); template.Name = 'global_views_pagination'; return template;});